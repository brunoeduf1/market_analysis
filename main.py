...
from options.options_fair_price import calc_exponential_historic_vol, calc_historic_vol, get_option_fair_price, get_symbol_price
...
# print(calc_exponential_historic_vol('ABEV3'))
